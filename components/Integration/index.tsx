      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Effortlessly Manage Your Data from Anywhere, Anytime.`,
              description: `Our seamless integration solutions ensure real-time data access and management, empowering your business to stay connected and operate efficiently across multiple platforms. Experience streamlined workflows and enhanced decision-making with secure and scalable data solutions.`,
            }}
          />
